...
fig_timeline.add_trace(
    go.Scatter(
        ...
        marker=dict(symbol='circle', size=10, color='#F1C40F', line=dict(color='#F8F9FA', width=2)),
...
st.markdown("""
<div style="background:#F8F9FA; padding:15px 20px; border-radius:8px; border-left:4px solid #F57C00; margin-top: 10px; margin-bottom: 25px;">
...
try:
    ...
    fig_kawasan.add_trace(go.Scatter(
        ...
        textposition='top center',
        textfont=dict(color='#111111', size=11, weight='bold'),
    ...
    st.markdown("""
    <div style="background:#F8F9FA; padding:15px 20px; border-radius:8px; border-left:4px solid #3498DB; margin-top: 10px; margin-bottom: 25px;">
        <span style="color: #E0E0E0; font-size: 0.95rem;">
...
st.markdown("""
<div style="background:#F8F9FA; padding:15px 20px; border-radius:8px; border-left:4px solid #E74C3C; margin-top: 10px; margin-bottom: 25px;">
    <span style="color: #E0E0E0; font-size: 0.95rem;">
...
st.markdown("""
<div style="background:#F8F9FA; padding:15px 20px; border-radius:8px; border-left:4px solid #F39C12; margin-top: 10px; margin-bottom: 25px;">
    <span style="color: #E0E0E0; font-size: 0.95rem;">
...
st.markdown("""
<div style="background:#F8F9FA; padding:15px 20px; border-radius:8px; border-left:4px solid #C0392B; margin-top: 10px; margin-bottom: 25px;">
    <span style="color: #E0E0E0; font-size: 0.95rem;">
