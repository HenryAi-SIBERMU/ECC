...
<div style="background-color: transparent; padding: 10px 0px; margin-bottom: 25px;">
    <h2 style="color: #111111; font-size: 1.8rem; margin-bottom: 15px; font-weight: 700;">Hilirisasi & Ilusi Kesejahteraan</h2>
...
st.markdown("""
<div style="background:#F8F9FA; padding:15px 20px; border-radius:8px; border-left:4px solid #66BB6A; margin-top: 10px; margin-bottom: 25px;">
...
st.markdown("""
<div style="background:#FFFFFF; padding:15px 20px; border-radius:8px; border-left:4px solid #FBC02D; margin-bottom: 25px;">
    <span style="color: #E0E0E0; font-size: 0.95rem;">
