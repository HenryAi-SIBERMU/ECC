...
<div style="background-color: transparent; padding: 10px 0px; margin-bottom: 25px;">
    <h2 style="color: #111111; font-size: 1.8rem; margin-bottom: 15px; font-weight: 700;">Hilirisasi yang Dibayar dengan Nyawa: Menggugat Mitos Pertumbuhan Hijau</h2>
    <p style="color: #424242; font-size: 1.05rem; line-height: 1.7; margin-bottom: 15px; text-align: justify;">
    ...
    <p style="color: #424242; font-size: 1.05rem; line-height: 1.7; text-align: justify;">
...
st.markdown("---")
st.markdown(
    '<h2 style="color: #111111; font-size: 24px;">3.1 Kesenjangan Fasilitas Kesehatan di Kawasan Ekstraktif</h2>',
    unsafe_allow_html=True,
)
...
st.markdown(
    """
<div style="background:#F8F9FA; padding:14px; border-radius:10px; border-left:5px solid #FF5722; margin-bottom: 25px;">
...
st.markdown("---")
st.markdown(
    '<h2 style="color: #111111; font-size: 24px;">3.3 Lintasan Waktu Ekologis & Ledakan Penyakit di Kawasan Industri Ekstraktif</h2>',
    unsafe_allow_html=True,
)
...
with col_res2:
    ...
    st.markdown(
        f"""
    <div style="background:#F8F9FA; padding:14px; border-radius:10px; border-left:5px solid {order_color}; height: 100%;">
...
if not df_zoonosis.empty:
    st.markdown("---")
    st.markdown(
        '<h2 style="color: #111111; font-size: 24px;">3.4 Anomali Zoonosis: Dampak Kritis Ekspansi Industri di Level Tapak (Studi Kasus Sulteng)</h2>',
        unsafe_allow_html=True,
    )
...
st.markdown("---")
st.markdown(
    '<h2 style="color: #111111; font-size: 24px;">3.5 Pemetaan Geospasial: Episentrum Ledakan Penyakit</h2>',
    unsafe_allow_html=True,
)
...
st.markdown("---")
st.markdown(
    '<h2 style="color: #111111; font-size: 24px;">3.6 Krisis Air Bersih: Penurunan IKA & Ledakan Kasus Diare di Kawasan Industri Ekstraktif</h2>',
    unsafe_allow_html=True,
)
...
st.markdown(
    f"""
<div style="background:#F8F9FA; padding:14px; border-radius:10px; border-left:5px solid #FBC02D; margin-bottom: 20px; margin-top: 15px;">
...
with col_res_ika2:
    ...
    st.markdown(
        f"""
    <div style="background:#F8F9FA; padding:14px; border-radius:10px; border-left:5px solid {order_color_ika}; height: 100%;">
        <b>Interpretasi Ekologis:</b><br><br>
        {interp_text_ika}
    </div>
    """,
...
st.markdown("---")
st.markdown(
    '<h2 style="color: #111111; font-size: 24px;">3.7 Beban Limbah Beracun (B3): Eksternalitas Kesehatan yang Diabaikan</h2>',
    unsafe_allow_html=True,
)
...
st.markdown(
    f"""
<div style="background: linear-gradient(135deg, #F8F9FA, #2C1810); padding: 20px; border-radius: 10px; border-left: 5px solid #E53935; margin-bottom: 25px;">
...
st.markdown(
    f"""
<div style="background:#F8F9FA; padding:14px; border-radius:10px; border-left:5px solid #E53935; margin-bottom: 20px; margin-top: 15px;">
...
st.markdown(
    f"""
<div style="background:#F8F9FA; padding:14px; border-radius:10px; border-left:5px solid #FF9800; margin-bottom: 20px; margin-top: 15px;">
...
st.markdown(
    f"""
<div style="background: linear-gradient(135deg, #F8F9FA, #2C1810); padding: 20px; border-radius: 10px; border-left: 5px solid #BF360C; margin-bottom: 25px; margin-top: 20px;">
