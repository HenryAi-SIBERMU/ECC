...
<div style="background-color: transparent; padding: 10px 0px; margin-bottom: 25px;">
    <h2 style="color: #111111; font-size: 1.8rem; margin-bottom: 15px; font-weight: 700;">Tumbal Ekologis: Ketika {tot_smelter} Smelter Mencekik Napas dan Air Sulawesi</h2>
...
st.markdown(f"""
<div style="background:#F8F9FA; padding:14px; border-radius:10px; border-left:5px solid #D32F2F; margin-bottom: 25px;">
...
<i style="color: #616161;">Geser slider tahun untuk membandingkan kondisi awal (2014) dengan kondisi terkini (2023). Anda akan melihat bagaimana provinsi dengan ekspansi konsesi tertinggi (bubble yang tumbuh besar) adalah yang paling cepat berubah warna dari hijau menjadi coklat — visualisasi nyata dari aneksasi ruang dan pembantaian hutan yang sistematis.</i>
"""
...
pertanyaan_text = """
<div style="background:linear-gradient(135deg, #FFFFFF, #F8F9FA);padding:20px;border-left:4px solid #D32F2F;border-radius:8px;margin-bottom:25px;">
