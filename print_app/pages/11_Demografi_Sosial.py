...
<div style="background-color: transparent; padding: 10px 0px; margin-bottom: 25px;">
    <h2 style="color: #111111; font-size: 1.8rem; margin-bottom: 15px; font-weight: 700;">Ketika Hilirisasi Mengubah Struktur Masyarakat</h2>
...
# ═════════════════════════════════════════════════════════════
st.markdown("---")
st.subheader("9.2 Intensifikasi Ruang: Kepadatan Industri Ekstraktif vs Non-Ekstraktif")
st.markdown(
...
# ═════════════════════════════════════════════════════════════
st.markdown("---")
st.subheader("9.3 Pergeseran Ekonomi Agraris ke Tambang dan Industri")
st.markdown(
...
# ═════════════════════════════════════════════════════════════
st.markdown("---")
st.subheader("9.4 Sintesis: Matriks Tekanan Sosial-Ekologis")
st.markdown(
