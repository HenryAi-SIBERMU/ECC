...
<div style="background-color: transparent; padding: 10px 0px; margin-bottom: 25px;">
    <h2 style="color: #111111; font-size: 1.8rem; margin-bottom: 15px; font-weight: 700;">Hilirisasi & Pembangunan Berlumur Konflik</h2>
...
<div style="background-color: rgba(3, 169, 244, 0.05); border-left: 4px solid #03A9F4; padding: 15px; border-radius: 4px; margin-bottom: 20px;">
    ...
    <p style="color: #111111; font-size: 0.95rem; line-height: 1.6; margin-bottom: 0;">
...
st.markdown("""
<div style="background:#F8F9FA; padding:14px; border-radius:10px; border-left:5px solid #FF9800; margin-bottom: 25px;">
...
st.markdown("""
<div style="background:#F8F9FA; padding:14px; border-radius:10px; border-left:5px solid #F44336; margin-bottom: 25px;">
...
st.markdown(f"""
<div style="background:#F8F9FA; padding:14px; border-radius:10px; border-left:5px solid #E53935; margin-bottom: 25px; margin-top: 25px;">
...
with col_ba1:
    st.markdown(f"""
    <div style="background:#F8F9FA; padding:20px; border-radius:10px; border-top:4px solid #9E9E9E;">
...
with col_ba2:
    st.markdown(f"""
    <div style="background:#F8F9FA; padding:20px; border-radius:10px; border-top:4px solid #E53935;">
...
st.markdown("<br>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; color: #757575; font-size: 0.9rem; margin-bottom: 5px;'><i>* Grafik di atas hanya menampilkan Top 10 entitas. Untuk melihat daftar lengkap dan detail seluruh aktor yang terdeteksi, silakan buka tabel data di bawah ini.</i></p>", unsafe_allow_html=True)
