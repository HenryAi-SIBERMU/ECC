# Product Requirements Document (PRD) — FASE 2
## CELIOS ECC Intelligence Dashboard
### Sistem Visualisasi Daya Dukung & Daya Tampung Lingkungan Hidup Indonesia
...
**Rentang Data:** 2019–2023 (5 tahun terakhir) — *permintaan tim riset*  
**Status Data:** ⚠️ Belum ada data sama sekali — `data/processed/` kosong, pipeline belum berjalan
...
>
> **Proyek ini tidak menggunakan data simulasi (mock data) dalam bentuk apapun.**
>
> Seluruh data yang ditampilkan di dashboard **harus bersumber dari data nyata** yang diperoleh dari sumber resmi berikut:
>
> | Sumber | Data yang Diambil |
> |--------|-------------------|
> | **BPS WebAPI** | Populasi, konsumsi pangan (Susenas), kendaraan, PDRB, IPM, Gini |
> | **Laporan PLN Statistik** | Konsumsi listrik per provinsi (GWh), faktor emisi grid |
> | **SIPSN KLHK** | Timbulan sampah per provinsi (ton/hari) |
> | **Statistik ESDM** | Konsumsi LPG/BBM per provinsi |
> | **Peta KLHK / BIG** | Tutupan lahan, kawasan lindung |
> | **BNPB InaRisk** | Area rawan banjir per provinsi |
> | **GFN National Footprint Accounts** | Yield Factor (YF) dan Equivalence Factor (EQF) — konstanta, tidak berubah |
>
> **Jika data dari sumber tertentu belum tersedia**, halaman terkait ditampilkan dengan banner "Sedang dalam pengembangan" — **bukan** diisi data buatan. Pipeline data harus menunggu ketersediaan data nyata sebelum halaman diaktifkan.
>
> Kebijakan ini berlaku untuk semua fase pengembangan, termasuk fase pengujian dan staging.
