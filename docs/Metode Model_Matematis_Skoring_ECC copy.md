...
* **Formula**:
  ```python
  Skor_Lahan_2 = min(10.0, (Deforestasi_Sentra_Ha / 570_000) * 10)
  ```
...
* **Formula**: Mengingat Sulteng adalah episentrum tambang terbesar (IMIP) namun datanya kosong/blank spot di GFW, model kita menerapkan **Data Gap Proxy Multiplier (x2)** dari data Sultra (513.561 Ha) untuk mengestimasi riil 2 provinsi. Threshold skala masif ditetapkan **1 Juta Ha**.
  ```python
