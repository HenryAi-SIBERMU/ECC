# Framework Riset — FASE 2
## Environmental Carrying Capacity (ECC) Intelligence Dashboard
### Sistem Visualisasi & Analitik Daya Dukung Lingkungan Hidup Indonesia

> 📌 **Ini adalah dokumen untuk FASE 2 dari total 3 fase proyek CELIOS.**  
> Fase 1 → `framework-fase1-d3tlh.md` | Fase 2 → *dokumen ini* | Fase 3 → TBD  

> **Referensi Metodologi Utama:** Świąder et al. (2020), *fenvs-08-579838*  
> **Konteks Lokal:** 38 Provinsi Indonesia | **Rentang Data: 2019–2023 (5 tahun terakhir)**  
> **Dokumen terkait:** `docs/paper-fondasi-ecc-swiader2020.md` | `docs/prd-fase2-ecc-dashboard.md`
...
>
> **Framework ini diimplementasikan menggunakan data nyata seutuhnya — tidak ada data simulasi (mock data) dalam bentuk apapun.**
>
> Setiap variabel dalam 48 indikator ECC **wajib bersumber dari data resmi** yang tercantum di Bagian 4 dokumen ini (BPS WebAPI, PLN Statistik, SIPSN KLHK, ESDM, KLHK, BNPB, GFN). Jika data belum tersedia pada saat pengembangan, halaman dashboard yang bergantung pada data tersebut **ditunda penayangan kontennya** hingga data nyata tersedia — bukan digantikan dengan data buatan.
>
> **Konsekuensi teknis:**
> - `data/prepare_data.py` hanya berjalan dengan data yang sudah diakuisisi dari sumber resmi
> - `data/processed/*.csv` tidak boleh diisi secara manual atau dengan angka rekayasa
> - Setiap kolom di `provinsi_ecc.csv` harus memiliki catatan sumber data yang dapat ditelusuri
...
|---|---|
| BPS API key belum tersedia | Tunggu key aktif — **tidak ada mock data** |
| Data belum tersedia sama sekali | `data/processed/` masih kosong — pipeline belum berjalan |
