...
split_point = '    print("Writing 100% faithful chapter_3.md ...")'
...
new_content = pre_content + split_point + """
...
**Interpretasi Komposisi Limbah:** Slag (**{slag_total / 1_000_000:.1f} juta ton/tahun**) dan Tailing (**{tailing_total / 1_000_000:.1f} juta ton/tahun**) mendominasi timbulan limbah B3.
