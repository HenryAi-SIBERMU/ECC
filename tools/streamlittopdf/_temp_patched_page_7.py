__file__ = r'C:\Users\yooma\OneDrive\Desktop\duniahub\client\4. Celios2\pages\7_Kegagalan_Tata_Kelola.py'
...
try:
    ...
    fig_prov.update_layout(plot_bgcolor='white', paper_bgcolor='white', margin=dict(l=0, r=0, t=30, b=0), height=300)
