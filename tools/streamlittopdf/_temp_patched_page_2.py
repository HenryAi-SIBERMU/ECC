__file__ = r'C:\Users\yooma\OneDrive\Desktop\duniahub\client\4. Celios2\pages\2_Kualitas_Lingkungan.py'
...
st.markdown(f"""
<div style="background:#FFFFFF; padding:14px; border-radius:10px; border-left:5px solid #D32F2F; margin-bottom: 25px;">
