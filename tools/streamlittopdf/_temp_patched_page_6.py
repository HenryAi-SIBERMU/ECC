__file__ = r'C:\Users\yooma\OneDrive\Desktop\duniahub\client\4. Celios2\pages\6_Audit_D3TLH.py'
...
# =====================================================================
st.markdown("""
<div style="background: #FFFFFF; padding: 20px; border-radius: 8px; border-left: 5px solid #F44336; margin-bottom: 30px;">
        ...
        with tab1:
            ...
            if not df_pltu_op.empty and not df_nasa.empty:
                ...
                fig_nasa_combined.update_layout(
                    ...
                    plot_bgcolor='white', paper_bgcolor='white', font=dict(color='#ECEFF1', family='Arial, sans-serif'),
