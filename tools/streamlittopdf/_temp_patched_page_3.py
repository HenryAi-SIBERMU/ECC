__file__ = r'C:\Users\yooma\OneDrive\Desktop\duniahub\client\4. Celios2\pages\3_Beban_Kesehatan.py'
import os
import sys
...
with col_res_ika2:
    ...
    st.markdown(
        f"""
    <div style="background:#FFFFFF; padding:14px; border-radius:10px; border-left:5px solid {order_color_ika}; height: 100%;">
        <b>Interpretasi Ekologis:</b><br><br>
        {interp_text_ika}
    </div>
    """,
...
st.markdown(
    f"""
<div style="background: linear-gradient(135deg, #FFFFFF, #2C1810); padding: 20px; border-radius: 10px; border-left: 5px solid #E53935; margin-bottom: 25px;">
...
st.markdown(
    f"""
<div style="background:#FFFFFF; padding:14px; border-radius:10px; border-left:5px solid #E53935; margin-bottom: 20px; margin-top: 15px;">
...
st.markdown(
    f"""
<div style="background:#FFFFFF; padding:14px; border-radius:10px; border-left:5px solid #FF9800; margin-bottom: 20px; margin-top: 15px;">
...
st.markdown(
    f"""
<div style="background: linear-gradient(135deg, #FFFFFF, #2C1810); padding: 20px; border-radius: 10px; border-left: 5px solid #BF360C; margin-bottom: 25px; margin-top: 20px;">
