...
|---|---|---|---|
| **Daya Tampung Udara** | **{skor_akumulasi_udara:.1f} / 10** | **DAYA TAMPUNG MELAMPAUI** | Kegagalan Deteksi Morbiditas Akumulatif *(Kapasitas PLTU: {kapasitas_terkini:,.0f} MW / NO2 NASA: {no2_terkini:.2e} / Rasio ISPA: {rasio_anomali:.1f}x)* |
| **Daya Tampung Air** | **{skor_akumulasi_air:.1f} / 10** | **DAYA TAMPUNG MELAMPAUI** | Kegagalan Pengukuran Toksisitas *(IKA Sulteng: {ika_sulteng:.1f} / Kasus Diare: {kasus_diare_sentra:,.0f} / Konflik Air: {jumlah_konflik_air})* |
| **Daya Dukung Lahan** | **{skor_akumulasi_lahan:.1f} / 10** | **KRISIS RUANG DARAT** | Kegagalan Mengukur Efek Domino Lanskap *(Bencana: {bencana_sulteng_sultra:,.0f} Kejadian / Deforestasi: {deforestasi_sentra:,.0f} Ha)* |
| **Daya Dukung Sosial** | **{skor_akumulasi_sosial:.1f} / 10** | **DARURAT AGRARIA** | Ilusi Jasa Budaya & Kedaulatan Ruang *(Konflik Lahan: {konflik_darat} Kasus TanahKita)* |
| **Veto Kebijakan** | **{skor_akumulasi_veto:.1f} / 10** | **REGULATORY CAPTURE** | Kegagalan Tata Kelola Negara *({izin_baru:,.0f} Izin Baru & {kapasitas_pltu/1000:,.1f} GW PLTU Captive Diloloskan)* |
...
> **Akumulasi Skor Kerusakan:** **{skor_akumulasi_udara:.1f} / 10** — *STATUS: DAYA TAMPUNG MELAMPAUI*
...
> **Akumulasi Skor Kerusakan:** **{skor_akumulasi_air:.1f} / 10** — *STATUS: DAYA TAMPUNG MELAMPAUI*
...
> **Skor Kerusakan Lahan:** **{skor_akumulasi_lahan:.1f} / 10** — *STATUS: KRISIS RUANG DARAT*
...
> **Skor Kerusakan Sosial:** **{skor_akumulasi_sosial:.1f} / 10** — *STATUS: KRISIS KEMANUSIAAN*
...
> **Skor Kegagalan Tata Kelola:** **{skor_akumulasi_veto:.1f} / 10** — *STATUS: REGULATORY CAPTURE*
