__file__ = r'C:\Users\yooma\OneDrive\Desktop\duniahub\client\4. Celios2\pages\4_Konflik_Sosial.py'
...
st.markdown("""
<div style="background:#FFFFFF; padding:14px; border-radius:10px; border-left:5px solid #FF9800; margin-bottom: 25px;">
...
st.markdown(f"""
<div style="background:#FFFFFF; padding:14px; border-radius:10px; border-left:5px solid #E53935; margin-bottom: 25px; margin-top: 25px;">
...
with col_ba1:
    st.markdown(f"""
    <div style="background:#FFFFFF; padding:20px; border-radius:10px; border-top:4px solid #9E9E9E;">
...
with col_ba2:
    st.markdown(f"""
    <div style="background:#FFFFFF; padding:20px; border-radius:10px; border-top:4px solid #E53935;">
