...
<div style="background-color: transparent; padding: 10px 0px; margin-bottom: 25px;">
    <h2 style="color: #000000; font-size: 1.8rem; margin-bottom: 15px; font-weight: 700;">Ekspansi Masif: {tot_smelter} Fasilitas Smelter Mengunci Lanskap Ekologis Sulawesi</h2>
...
bars = alt.Chart(df_smelter_prov).mark_bar(cornerRadiusEnd=2).encode(
    y=alt.Y('provinsi:N', sort='-x', title='', axis=alt.Axis(labelColor='#424242')),
    x=alt.X('Persentase:Q', title='Porsi Izin (%)', axis=alt.Axis(gridOpacity=0.1, labelColor='#424242')),
...
with col_chart_s:
    ...
    chart_s = alt.Chart(df_s).mark_bar(opacity=0.8, color='#F57C00').encode(
        x=alt.X('Tahun:O', title='', axis=alt.Axis(labelAngle=-45, labelColor='#424242')),
        y=alt.Y('Total_Luas_Konsesi_Baru_Ha:Q', scale=alt.Scale(domain=[0, max_y_izin]), title='Luas Konsesi Baru (Ha)', axis=alt.Axis(gridOpacity=0.05, labelColor='#424242', titleColor='#424242')),
...
try:
    ...
    chart_primary = alt.Chart(df_primary_agg).mark_bar(color='#E91E63').encode(
        x=alt.X('umd_tree_cover_loss__year:O', title='Tahun', axis=alt.Axis(labelAngle=-45, labelColor='#424242', titleColor='#424242')),
        y=alt.Y('area__ha:Q', title='Hutan Primer Hilang (Ha)', axis=alt.Axis(labelColor='#424242', titleColor='#424242', gridOpacity=0.05)),
        tooltip=['umd_tree_cover_loss__year', alt.Tooltip('area__ha', format=',.0f')]
    ).properties(height=350, title=alt.TitleParams(text="Tragedi Hutan Primer", color='#212121'))
...
with col1:
    st.markdown("""
    <div style="background-color: #000000; padding: 20px; border-radius: 10px; border: 1px solid #E0E0E0;">
        <div style="color: #424242; font-size: 0.85rem; font-weight: 600; margin-bottom: 10px; text-transform: uppercase; text-align: center;">Pelabuhan Nikel Terkonfirmasi</div>
        <div style="color: #48BB78; font-size: 2.5rem; font-weight: bold; text-align: center; margin-bottom: 15px;">6</div>
        <div style="color: #424242; font-size: 0.85rem; margin-bottom: 20px; text-align: left;">Seluruh lokasi industri nikel besar di Sulawesi terbukti memiliki pelabuhan atau dermaga ekspor.</div>
        <div style="color: #424242; font-size: 0.75rem; border-top: 1px solid #E0E0E0; padding-top: 10px;">Sumber: Situs perusahaan, dokumen pemerintah, media (25 sumber)<br>File: sulawesi_logistik_simpul_nikel.csv</div>
    </div>
    """, unsafe_allow_html=True)
with col2:
    st.markdown("""
    <div style="background-color: #000000; padding: 20px; border-radius: 10px; border: 1px solid #E0E0E0;">
        <div style="color: #424242; font-size: 0.85rem; font-weight: 600; margin-bottom: 10px; text-transform: uppercase; text-align: center;">Berlabel Proyek Strategis Nasional</div>
        <div style="color: #ECC94B; font-size: 2.5rem; font-weight: bold; text-align: center; margin-bottom: 15px;">4 <span style="font-size: 1.2rem; color: #424242;">/ 6</span></div>
        <div style="color: #424242; font-size: 0.85rem; margin-bottom: 20px; text-align: left;">Label PSN mempercepat perizinan dan memudahkan pembebasan lahan warga sekitar.</div>
        <div style="color: #424242; font-size: 0.75rem; border-top: 1px solid #E0E0E0; padding-top: 10px;">Sumber: KPPIP, Perpres 58/2017, Perpres 12/2025</div>
    </div>
    """, unsafe_allow_html=True)
with col3:
    st.markdown("""
    <div style="background-color: #000000; padding: 20px; border-radius: 10px; border: 1px solid #E0E0E0;">
        <div style="color: #424242; font-size: 0.85rem; font-weight: 600; margin-bottom: 10px; text-transform: uppercase; text-align: center;">Pelabuhan Terbesar</div>
        <div style="color: #63B3ED; font-size: 2.5rem; font-weight: bold; text-align: center; margin-bottom: 15px;">50.000 <span style="font-size: 1.2rem; color: #424242;">ton</span></div>
        <div style="color: #424242; font-size: 0.85rem; margin-bottom: 20px; text-align: left;">GNI Petasia memiliki pelabuhan yang mampu menampung kapal pengangkut berkapasitas hingga 50.000 ton.</div>
        <div style="color: #424242; font-size: 0.75rem; border-top: 1px solid #E0E0E0; padding-top: 10px;">Sumber: gunbusternickelindustry.com</div>
    </div>
    """, unsafe_allow_html=True)
