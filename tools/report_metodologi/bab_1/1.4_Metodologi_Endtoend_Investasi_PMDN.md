...
**Tabel Uji Coba Ekstraksi API BPS Seluruh Provinsi Sulawesi:**
*(Kopi-paste salah satu URL berikut ke dalam Postman untuk memvalidasi secara manual ketersediaan data investasi & fiskal tiap provinsi dari server BPS Nasional)*

| Provinsi | Kode Wilayah | URL Endpoint Postman (Var PMDN 793) |
| :--- | :--- | :--- |
| **Sulawesi Utara** | `7100` | `https://webapi.bps.go.id/v1/api/list/model/data/domain/7100/var/793/th/116:117/key/06fd644648629502353deaed29fc6383/` |
| **Sulawesi Tengah** | `7200` | `https://webapi.bps.go.id/v1/api/list/model/data/domain/7200/var/793/th/116:117/key/06fd644648629502353deaed29fc6383/` |
| **Sulawesi Selatan** | `7300` | `https://webapi.bps.go.id/v1/api/list/model/data/domain/7300/var/793/th/116:117/key/06fd644648629502353deaed29fc6383/` |
| **Sulawesi Tenggara** | `7400` | `https://webapi.bps.go.id/v1/api/list/model/data/domain/7400/var/793/th/116:117/key/06fd644648629502353deaed29fc6383/` |
| **Gorontalo** | `7500` | `https://webapi.bps.go.id/v1/api/list/model/data/domain/7500/var/793/th/116:117/key/06fd644648629502353deaed29fc6383/` |
| **Sulawesi Barat** | `7600` | `https://webapi.bps.go.id/v1/api/list/model/data/domain/7600/var/793/th/116:117/key/06fd644648629502353deaed29fc6383/` |
