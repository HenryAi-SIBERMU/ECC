...
> **Skrip Transformasi:** `tools/bpsapi/fetch_bps_investasi_pmdn.py` dan `tools/bpsapi/fetch_pad_sulawesi.py`
...
graph TD
    %% TAHAP 1
    Step1["Langkah 1: Request API / Download Portal<br/><b>Target:</b> BPS / Portal BKPM<br/><b>Script:</b> fetch_bps_investasi_pmdn.py & fetch_pad_sulawesi.py"] -->|Server Merespons| Res1[/"Tabel Registri Nasional<br/>(nasional_investasi_pmdn_2016_2024.csv)"/]
