...
def deduce_sulawesi_province(text: str, default_val: str = "Sulawesi (unspecified)") -> str:
    ...
    if 'minahasa' in text or 'sulawesi utara' in text or 'sulut' in text or 'manado' in text or 'bitung' in text or 'sangihe' in text or 'talaud' in text or 'kotamobagu' in text or 'bolaang' in text or 'sitaro' in text:
