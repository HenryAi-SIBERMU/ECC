"""
GFW MEGA DATA FETCH V3 - Corrected Layer Names
================================================
...
# OFFICIAL GEOSTORE MAPPING (Admin Boundaries)
# Diturunkan langsung dari API /v3/geostore/admin/IDN/{admin_code}
GEOSTORE_MAPPING = {
    "Gorontalo": "8d998ed751ba37bf689febf729f30304",
    "Sulawesi Barat": "796e2f453e81e409e183d833c586ff34",
    "Sulawesi Selatan": "33c45193c87f0505647dfae91a796b67",
    "Sulawesi Tengah": "70415db2d291955e71d4b08466cd6136",
    "Sulawesi Tenggara": "3c79929a54bff963e7bf3a4762b803e9",
    "Sulawesi Utara": "b779acdc5c7617db5a10ffcebde6a2e9"
}
...
def main():
    print("\n" + "="*70)
    print("GFW MEGA DATA FETCH V3 - CORRECTED LAYER NAMES")
    print("="*70)
