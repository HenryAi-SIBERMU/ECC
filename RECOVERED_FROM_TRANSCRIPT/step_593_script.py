...
if old_text in content:
    ...
    print("Spatial text not found.")


# 2. CHANGE ONLY THE LABEL IN IKU GRAPH (Keep the color scale exactly the same)
...
if old_iku_label in content:
    ...
    print("IKU label target not found.")
